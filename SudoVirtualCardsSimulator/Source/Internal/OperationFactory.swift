...
class OperationFactory {
    ...
    ///   - graphQLClient: GraphQL client  used to perform the query.
    ...
    func generateQueryOperation<Query: GraphQLQuery>(
        ...
        return PlatformQueryOperation(graphQLClient: graphQLClient, query: query, cachePolicy: cachePolicy, logger: logger)
    }
    ...
    ///   - graphQLClient: GraphQL used to perform the mutation.
